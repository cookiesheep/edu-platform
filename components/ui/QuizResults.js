...
import { BarChart2, Search, Brain, RefreshCw, Sparkles, Download, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
          ...
          >
            <div className="text-center mb-10">
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 flex items-center mx-auto"
              >
