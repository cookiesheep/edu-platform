      ...
      <div className="w-full max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 items-center relative z-10">
        ...
        >
          <div className="text-center lg:text-left">
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-cyan-500/20 mr-3 border border-white/10">
                <Sparkles className="w-8 h-8 text-white" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white">EduPlatform</h1>
                <p className="text-sm text-slate-400">智能学习平台</p>
              </div>
            </motion.div>
          ...
          <div className="space-y-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ x: 10 }}
              >
                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-cyan-500/10 to-blue-600/10 rounded-xl flex items-center justify-center text-cyan-400 border border-cyan-500/20">
                  {feature.icon}
                </div>
                <div>
        ...
        >
          <div className="glass-panel rounded-2xl shadow-2xl border border-white/10 p-8 bg-[#0f172a]/60 backdrop-blur-xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-2">登录账户</h2>
              <p className="text-slate-400">
                还没有账户？
                <Link href="/register" className="ml-1 font-medium text-cyan-400 hover:text-cyan-300 transition-colors">
                  立即注册
                </Link>
              </p>
            </div>
            ...
            <AnimatePresence mode="wait">
              {error && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="mb-4 p-4 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center"
                >
              ...
              {message && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="mb-4 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center"
                >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-cyan-600 focus:ring-cyan-500 border-white/10 rounded bg-[#020617]/50"
                  />
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-[#0f172a] text-slate-500">或使用第三方登录</span>
                </div>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-400">
                想要先体验？
                <Link href="/ai-assistant" className="ml-1 font-medium text-cyan-400 hover:text-cyan-300 transition-colors">
                  游客模式使用AI助手
                </Link>
              </p>
            </div>
